...
##### v.3.0.10 - 2015-09-10
* Removed data attribute as a way of tracking which elements sdeeplink has been assigned to. fixes #254, fixes #200.

##### v.3.0.9 - 2015-09-02
* Fixed issue with assigning sdeeplink to detached nodes. Merged #253, Fixes #234.

##### v.3.0.8 - 2015-06-29
* Fixed the `sdeeplink:resized` event not being triggered when the overflow changes. Fixes #244.
...
* Added new methods for updating and destroying:
	...
	* sdeeplink.update(elements)
	* sdeeplink.destroy(elements)

* Renamed custom events as to not use jQuery's custom events namespace:

	* sdeeplink.resized renamed to sdeeplink:resized
	* sdeeplink.update renamed to sdeeplink:update
	* sdeeplink.destroy renamed to sdeeplink:destroy
...
* New API.  Example usage: `sdeeplink(document.querySelectorAll(textarea));`
